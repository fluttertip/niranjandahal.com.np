...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xa(e,t,n){return new Ei({name:`SphericalGaussianBlur`,defines:{SAMPLES:Fa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:$a(),fragmentShader:`
	...
	`}var eo=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new di(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),(0,Bc.jsx)(`div`,{ref:e,style:{position:`absolute`,inset:0,zIndex:0}}),(0,Bc.jsx)(`div`,{style:{position:`absolute`,inset:0,zIndex:1,pointerEvents:`none`,background:`radial-gradient(ellipse at 50% 40%, transparent 0%, rgba(8,7,12,0.55) 65%, rgba(8,7,12,0.95) 100%)`}}),(0,Bc.jsx)(`div`,{style:{position:`absolute`,right:`28px`,top:`50%`,transform:`translateY(-50%)`,zIndex:3,display:`flex`,flexDirection:`column`,gap:`14px`},children:[`hero`,`about`,`more`,`contact`].map((e,t)=>(0,Bc.jsx)(`div`,{onClick:()=>i(e),className:`navdot`,style:{width:`6px`,height:`6px`,borderRadius:`50%`,cursor:`pointer`,background:r>=t*.25&&r<(t+1)*.25?`#e8e6f0`:`rgba(232,230,240,0.28)`,transform:r>=t*.25&&r<(t+1)*.25?`scale(1.7)`:`scale(1)`}},e))}),(0,Bc.jsxs)(`div`,{ref:t,className:`scrollarea`,style:{position:`relative`,zIndex:2,height:`100%`,overflowY:`auto`,scrollBehavior:`smooth`},children:[(0,Bc.jsxs)(`section`,{id:`hero`,style:{minHeight:`100vh`,display:`flex`,flexDirection:`column`,justifyContent:`center`,padding:`0 8vw`,maxWidth:`900px`},children:[(0,Bc.jsx)(`div`,{className:`in`,style:{color:`#9d95c9`,fontSize:`14px`,letterSpacing:`0.02em`,marginBottom:`18px`},children:Vc}),(0,Bc.jsx)(`h1`,{className:`fr`,style:{color:`#f2f0f7`,fontSize:`clamp(2.4rem, 6.4vw, 4.6rem)`,fontWeight:500,lineHeight:1.12,margin:0,maxWidth:`760px`},children:Hc}),(0,Bc.jsxs)(`div`,{className:`in`,onClick:()=>i(`about`),style:{marginTop:`56px`,color:`#7c6fff`,fontSize:`13px`,cursor:`pointer`,display:`flex`,alignItems:`center`,gap:`10px`},children:[(0,Bc.jsx)(`span`,{style:{width:`24px`,height:`1px`,background:`#7c6fff`}}),`scroll`]})]}),(0,Bc.jsx)(`section`,{id:`about`,style:{minHeight:`100vh`,display:`flex`,alignItems:`center`,padding:`0 8vw`},children:(0,Bc.jsx)(Yc,{className:`fr`,children:(0,Bc.jsx)(`p`,{style:{color:`#e8e6f0`,fontSize:`clamp(1.6rem, 3.6vw, 2.8rem)`,lineHeight:1.4,fontWeight:300,maxWidth:`640px`},children:Uc})})}),(0,Bc.jsx)(`section`,{id:`more`,style:{minHeight:`100vh`,display:`flex`,alignItems:`center`,padding:`0 8vw`},children:(0,Bc.jsx)(Yc,{className:`fr`,children:(0,Bc.jsx)(`p`,{style:{color:`#e8e6f0`,fontSize:`clamp(1.6rem, 3.6vw, 2.8rem)`,lineHeight:1.4,fontWeight:300,maxWidth:`640px`},children:Wc})})}),(0,Bc.jsx)(`section`,{id:`contact`,style:{minHeight:`100vh`,display:`flex`,flexDirection:`column`,justifyContent:`center`,padding:`0 8vw`},children:(0,Bc.jsxs)(Yc,{children:[(0,Bc.jsx)(`span`,{className:`fr`,style:{display:`block`,color:`#f2f0f7`,fontSize:`clamp(1.4rem, 3vw, 2rem)`,fontWeight:500},children:Kc}),(0,Bc.jsx)(`a`,{href:`mailto:${Gc}`,className:`fr`,style:{display:`block`,marginTop:`14px`,color:`#9d95c9`,fontSize:`clamp(1.1rem, 2.2vw, 1.5rem)`,fontWeight:300,textDecoration:`none`},children:Gc})]})})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,Bc.jsx)(_.StrictMode,{children:(0,Bc.jsx)(Xc,{})}));